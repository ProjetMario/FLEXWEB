...
export function territorialDossier(axis,c,e){
 ...
 {title:'Présenter des preuves qui correspondent au périmètre',text:`Réunissez des réalisations autorisées et indiquez ce qu’elles démontrent : service fourni, périmètre et limites. Une réalisation extérieure à ${c.name} peut expliquer une méthode, mais doit conserver sa localisation réelle. Si aucune preuve locale n’existe, présentez uniquement votre mode d’accompagnement réel et expliquez comment une demande est qualifiée, sans inventer de référence ni de lieu d’accueil.`,deliverable:'Des exemples sourcés, un responsable de réponse et une mesure des demandes effectivement qualifiées.'},
 ]:[
 ...
 'Décrire le besoin propre à votre entreprise et réunir les exemples que vous avez l’autorisation de présenter.',
 'Choisir un responsable, tester un cas complet et un cas incomplet, puis valider les actions avant de les activer.',
 ];
