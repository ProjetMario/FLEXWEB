...
export const automationPages: Record<string, AutomationPage> = {
  france: {
    ...
    faq: [
      ...
      { question: "Combien coûte une automatisation avec un CRM ?", answer: "L’offre CRM et automatisation est à 990 € TTC en paiement unique. Elle couvre la mise en place des contacts, devis, factures et du suivi client avec les tâches répétitives définies au devis. Un besoin IA sur mesure au-delà de ce périmètre est chiffré séparément. Le suivi CRM, automatisation et référencement à 99 € TTC/mois reste facultatif et comprend aussi le suivi des dernières technologies (veille et recommandations adaptées aux outils du projet). Les abonnements et consommations éventuels des outils tiers sont précisés dans la proposition." },
  ...
  savoie: {
    ...
    faq: [
      ...
      { question: "Comment démarrer un projet en Savoie ?", answer: "Décrivez dans la demande de devis une tâche répétitive, les outils utilisés et la fréquence du besoin. L’offre CRM et automatisation à 990 € TTC en paiement unique organise les contacts, devis, factures et le suivi client. Le cadrage confirme les tâches incluses, les connexions et les contrôles. Les développements IA spécifiques au-delà de ce périmètre font l’objet d’un devis adapté." },
    ],
  },
  hauteSavoie: {
    ...
    faq: [
      ...
      { question: "Quel budget prévoir pour mon projet en Haute-Savoie ?", answer: "La mise en place du CRM et de l’automatisation est à 990 € TTC en paiement unique : contacts, devis, factures, suivi client et tâches répétitives définies au devis. Les besoins IA sur mesure hors de ce périmètre sont chiffrés séparément. Le devis précise les prestations et les frais récurrents éventuels liés aux logiciels, aux volumes et au suivi." },
    ],
  },
};
